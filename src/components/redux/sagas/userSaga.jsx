...
import { CREATE_NEW_USER, GET_TOKEN, GET_USER_INFO, GET_USER_ORDERS } from "../../../gql";
import "../../../../node_modules/react-toastify/dist/ReactToastify.css"
import { GET_TOKEN_ACTION, GET_TOKEN_LOGIN_ACTION, GET_USER_INFO_ACTION, GET_USER_ORDERS_ACTION, setUserAuthorized, setUserInfo,  setUserOrders,  setUserTokenAC } from "../reducers/userReducer";
...
function* getUserOrders(action) {
    ...
    try {
        ...
        const res = yield call(() => client.query({
            ...
            variables: { userId: JSON.stringify([{ ___owner: userId }]) },  
            context: {
                headers: {
                    Authorization: `Bearer ${token}`, 
                },
        ...
        if (res.data && res.data.OrderFind) {
            yield put(setUserOrders(res.data.OrderFind));  
        }
    } catch (error) {
        console.log(error);
    }
...
export function* userSaga(){
    ...
    yield takeEvery(GET_USER_ORDERS_ACTION, getUserOrders);
}